...
-- CreateIndex
CREATE INDEX "firstName_lastName" ON "Candidate"("firstName", "lastName");

-- CreateIndex
CREATE INDEX "email" ON "Candidate"("email");

-- CreateIndex
CREATE INDEX "institution_index" ON "Education"("institution");

-- CreateIndex
CREATE INDEX "company_index" ON "WorkExperience"("company");

-- CreateIndex
CREATE UNIQUE INDEX "Employee_email_key" ON "Employee"("email");

-- CreateIndex
CREATE INDEX "position_status" ON "Application"("positionId", "status");

-- CreateIndex
CREATE INDEX "application_date" ON "Application"("applicationDate");

-- CreateIndex
CREATE INDEX "interview_result" ON "Interview"("result");
